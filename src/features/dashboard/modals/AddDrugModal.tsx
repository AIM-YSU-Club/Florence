				...
				<div className="flex flex-col gap-5">
					...
					<div className="flex flex-col gap-1.5">
						...
						<input
							...
							className="rounded-lg border border-(--border) bg-(--bg) px-3.5 py-2.5 text-sm font-medium text-(--text-h) transition-all outline-none placeholder:text-(--text-muted) focus:border-(--primary) focus:shadow-[0_0_0_3px_var(--accent-bg)]"
						/>
					</div>
					...
					<div className="relative flex flex-col gap-1.5">
						...
						{showSuggestions &&
							...
							filteredSuggestions.length > 0 && (
								<div className="absolute top-full left-0 z-10 mt-1 max-h-32 w-full overflow-y-auto rounded-lg border border-(--border) bg-(--card) py-1 shadow-(--shadow)">
